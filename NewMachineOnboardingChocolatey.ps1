...
###############################################################################################
###############################################################################################
#Script: MTP Onboarding Script W/Chocolatey
#Date: 10/29/2019
#Author: Blake Pierantoni
#Description:
#I designed this automation script to run with the chocolatey package manager. The script will do the following: Enable RDP, Turn off Windows Firewall, Set power configuration to High Performance, Prevent NICs from --
#Turning off to save power, Install Chocolatey Package Manager and then connect to a company repository, Install Company RMM tool (Optional), Install Firefox, Chrome, Adobe Reader, Create Local Admin accounts on --
#The Target Machine.
###############################################################################################
###############################################################################################
###############################################################################################
##############################################################################################################################################################################################
Write-Host "Beginning MTP Onboarding Script"
...
###############################################################################################
############################################
#Install Chocolatey from MTP Repo
#You will need to comment some of this out or add your own company repository. I have redacted sensitive information.


Write-Host "Beginning Chocolatey Installation"


$packageRepo = 'https://deploy.mytechpro.com:1337/chocolatey'
...
$repoUsername = #Add repository username here   
$repoPassword = #Add repository Password here    
$unzipMethod = 'builtin'
...
###############################################################################################
############################################
#Connect to MTP Chocolatey Repo
#


Write-Host "Connnecting to the MTP Chocolatey Repository"
#This line of code will connects you to a chocolatey repository. I have redacted sensitive information
choco source add -n=mtprepo -s='https://deploy.mytechpro.com:1337/chocolatey' -u=#YourRepositoryUsername -p=#YourRepositoryPassword
...
###############################################################################################
############################################
#Install Generic Apps using chocolatey
#

Write-Host "Installing Adobe Reader, Google Chrome, and Mozilla Firefox...This may take a few minutes"
choco install adobereader googlechrome firefox --yes
...
$PlainPassword = #enter password for Software Admin Account

$SecurePassword = $PlainPassword | ConvertTo-SecureString -AsPlainText -Force

#Converting Password for MyTechPro Account as secure string
$PlainPassword2 = #enter password for MyTechPro Admin Account
...
#Catching the account doesnt exist error and reports back to console
Catch [Microsoft.PowerShell.Commands.UserNotFoundException] {
    "Local Account $($USERNAME2) was not found" | Write-Host
}
...
###############################################################################################
############################################
#Install MTP AEM Agent
#


Write-Host "Installing AEM Agent for MTP Staging Site"
#This would hypothetically install an RMM agent
#choco install aemagent-mtpstaging --yes



###############################################################################################

Write-Host "MTP Onboarding Script has completed."
